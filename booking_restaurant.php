...
<head>
    ...
    <link rel="stylesheet" href="style_booking_restaurant.css">
            ...
            <ul class="items">
                <li class="main_box" data-category="" data-price="" action="booking_db.php" method="post">
                    ...
                    <?php 
                        ...
                        $qry = $conn->query("SELECT * FROM  list_booking NATURAL JOIN list_promotion NATURAL JOIN type_booking WHERE(Partial_Type_Booking_ID = 4 AND StartPromotion = '2022-01-01')");
                        ...
                        <div class="right grid2 ">
                            <div class="right1">
                                ...
                                <ul class="nav_list">
                                    ...
                                    <li class="list">
                                        <a class="view"> <i class="fa-solid fa-star"></i> </a>
                                        <p>คุณภาพอาหารระดับ 5 ดาว</p>
                                    </li>
                                    <li class="list">
                                        <a class="shower"> <i class="fa-solid fa-martini-glass"></i> </a>
                                        <p>ราคารวมเครื่องดื่ม</p>
                                    </li>
                                </ul>
                            </div>
                            <div class="right2">
                            ...
                            <form action="Payment_restaurant.php">
