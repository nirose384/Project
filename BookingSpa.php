            ...
            <ul class="items">
                <li class="main_box" data-category="" data-price="" action="booking_db.php" method="post">
                    ...
                    <?php 
                        ...
                        $qry = $conn->query("SELECT * FROM  list_booking NATURAL JOIN list_promotion NATURAL JOIN type_booking WHERE(Partial_Type_Booking_ID = 1 AND StartPromotion = '2022-01-01')");
                    ...
                    <div class="box flex_room">
                        ...
                        <div class="right grid2 ">
                            <div class="right1">
                                ...
                                <ul class="nav_list">
                                    <li class="list">
                                        <a class="view"> <i class="fa-solid fa-clock"></i> </a>
                                        <p>สปาคอร์สละ 1.30 ชม.</p>
                                    </li>
                                    <li class="list">
                                        <a class="view"> <i class="fa-solid fa-wine-glass"></i> </a>
                                        <p>ฟรีเครื่องดื่มในรายการ 1 แก้ว</p>
                                    </li>
