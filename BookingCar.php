...
<head>
    ...
    <link rel="stylesheet" href="style_booking_car.css">
            ...
            <ul class="items">
                <li class="main_box" data-category="" data-price="" action="booking_db.php" method="post">
                    ...
                    <?php 
                        ...
                        $qry = $conn->query("SELECT * FROM  list_booking NATURAL JOIN list_promotion NATURAL JOIN type_booking WHERE(Partial_Type_Booking_ID = 2 AND StartPromotion = '2022-01-01')");
                    ...
                    <div class="box flex_room">
                        ...
                        <div class="right grid2 ">
                            <div class="right1">
                                ...
                                <ul class="nav_list">
                                    <li class="list">
                                        <a class="view"> <i class="fa-solid fa-user"></i> </a>
                                        <p>มีบริการคนขับรถ</p>
                                    </li>
                                    <li class="list">
                                        <a class="view"> <i class="fa-solid fa-list-check"></i> </a>
                                        <p>ตรวจสภาพรถและทำความสะอาดฟรี</p>
                                    </li>
                                    <li class="list">
                                        <a class="shower"> <i class="fa-solid fa-gas-pump"></i></a>
                                        <p>น้ำมันเต็มถัง</p>
                                    </li>
                                </ul>
                            </div>
