...
<head>
    ...
    <link rel="stylesheet" href="style_booking_boat.css">
            ...
            <ul class="items">
                <li class="main_box" data-category="" data-price="" action="booking_db.php" method="post">
                    ...
                    <?php 
                        ...
                        $qry = $conn->query("SELECT * FROM  list_booking NATURAL JOIN list_promotion NATURAL JOIN type_booking WHERE(Partial_Type_Booking_ID = 3 AND StartPromotion = '2022-01-01')");
                    ...
                    <div class="box flex_room">
                        ...
                        <div class="right grid2 ">
                            <div class="right1">
                                ...
                                <ul class="nav_list">
                                    <li class="list">
                                        <a class="view"> <i class="fa-solid fa-toilet"></i></a>
                                        <p>มีห้องน้ำรับรอง</p>
                                    </li>
                                    <li class="list">
                                        <a class="view"> <i class="fal fa-alarm-clock"></i> </a>
                                        <p>ให้บริการ 12 ชั่วโมง</p>
                                    </li>
                                    <li class="list">
                                        <a class="shower"> <i class="fa-solid fa-user"></i> </a>
                                        <p>มีบริการคนขับเรือ</p>
                                    </li>
                                    <li class="list">
                                        <a class="bed"> <i class="fa-solid fa-gas-pump"></i> </a>
                                        <p>ไม่คิดค่าน้ำมัน</p>
                                    </li>
                                </ul>
                            </div>
